<%-- 
    Document   : UserChangePw
    Created on : May 10, 2021, 1:26:33 AM
    Author     : this pc
--%>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="UserChangePw.jsp">Change Password</a></li>
						...
						<div class="shiping-details">
							<div class="section-title">
								<h3 class="title">Change Your Password</h3>
                                                    ...
                                                    <jsp:include page="UserChangePassword.jsp"/>
                                                </div>
                                        </div>
                </div>
                </div>
