<%-- 
    Document   : UserSellHistory
    Created on : May 10, 2021, 1:33:21 AM
    Author     : this pc
--%>
...
<html>
    <head>
        ...
        <title>Merch store | Sell History</title>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="UserSellHistory.jsp">Sell History</a></li>
					...
					<div class="col-md-7">
						...
						<div class="shiping-details">
							<div class="section-title">
								<h3 class="title">My sell history</h3>
							</div>
                                                    <div class="row">
                                                    <jsp:include page="UserSellHistoryData.jsp"/>
                                                    </div>
                                                </div>
                                        </div>
                </div>
